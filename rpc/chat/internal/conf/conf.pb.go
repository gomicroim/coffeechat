...
func (x *Data) GetTimeline() *Timeline {
	if x != nil {
		return x.Timeline
	}
	return nil
...
func (x *Timeline) GetGrpcAddr() string {
	if x != nil {
		return x.GrpcAddr
	}
	return ""
...
type Data_ConsumerTopic struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	OutboxWrite string `protobuf:"bytes,1,opt,name=outbox_write,json=outboxWrite,proto3" json:"outbox_write,omitempty"`
}

func (x *Data_ConsumerTopic) Reset() {
	*x = Data_ConsumerTopic{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_ConsumerTopic) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_ConsumerTopic) ProtoMessage() {}

func (x *Data_ConsumerTopic) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_ConsumerTopic.ProtoReflect.Descriptor instead.
func (*Data_ConsumerTopic) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 0}
}

func (x *Data_ConsumerTopic) GetOutboxWrite() string {
	if x != nil {
		return x.OutboxWrite
	}
	return ""
}

type Data_ProducerTopic struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Data_ProducerTopic) Reset() {
	*x = Data_ProducerTopic{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_ProducerTopic) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_ProducerTopic) ProtoMessage() {}

func (x *Data_ProducerTopic) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_ProducerTopic.ProtoReflect.Descriptor instead.
func (*Data_ProducerTopic) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 1}
}

func (x *Data_ProducerTopic) GetOutboxWrite() string {
	if x != nil {
		return x.OutboxWrite
	}
	return ""
...
func (x *Data_ProducerTopic) GetDead() string {
	if x != nil {
		return x.Dead
	}
	return ""
...
type Data_Kafka struct {
	...
	ConsumerTopics *Data_ConsumerTopic `protobuf:"bytes,3,opt,name=consumer_topics,json=consumerTopics,proto3" json:"consumer_topics,omitempty"`
	ProducerTopics *Data_ProducerTopic `protobuf:"bytes,4,opt,name=producer_topics,json=producerTopics,proto3" json:"producer_topics,omitempty"`
}
...
func (x *Data_Kafka) GetConsumerTopics() *Data_ConsumerTopic {
	if x != nil {
		return x.ConsumerTopics
	}
	return nil
}

func (x *Data_Kafka) GetProducerTopics() *Data_ProducerTopic {
	if x != nil {
		return x.ProducerTopics
	}
	return nil
}
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xe6, 0x06, 0x0a, 0x04,
	...
	,
	...
	,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Timeline)(nil),            // 4: kratos.api.Timeline
	(*Server_GRPC)(nil),         // 5: kratos.api.Server.GRPC
	(*Data_ConsumerTopic)(nil),  // 6: kratos.api.Data.ConsumerTopic
	(*Data_ProducerTopic)(nil),  // 7: kratos.api.Data.ProducerTopic
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 6: kratos.api.Data.timeline:type_name -> kratos.api.Timeline
	10, // 7: kratos.api.Data.kafka:type_name -> kratos.api.Data.Kafka
	...
	6,  // 13: kratos.api.Data.Kafka.consumer_topics:type_name -> kratos.api.Data.ConsumerTopic
	7,  // 14: kratos.api.Data.Kafka.producer_topics:type_name -> kratos.api.Data.ProducerTopic
...
func file_internal_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_conf_conf_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Data_ConsumerTopic); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_internal_conf_conf_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Data_ProducerTopic); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
