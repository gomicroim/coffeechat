...
type SyncMessageReply_TimelineEntry struct {
	...
	Message  []*wspush.IMMsg `protobuf:"bytes,2,rep,name=message,proto3" json:"message,omitempty"`
}
...
var file_protos_api_api_chat_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x77, 0x73, 0x70, 0x75, 0x73, 0x68, 0x2e, 0x49, 0x4d,
